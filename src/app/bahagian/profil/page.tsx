...
export default function ProfilBahagian() {
  ...
  if (loading) {
    return <div className="p-8 text-teal-700 font-bold animate-pulse">Memuatkan maklumat profil...</div>;
  }

  return (
    <div className="p-4 sm:p-8 relative z-10 max-w-3xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-teal-900">Profil Saya</h1>
        <p className="text-teal-700 mt-1 font-medium">Lihat maklumat akaun dan urus keselamatan log masuk anda.</p>
      </div>

      {/* KAD MAKLUMAT PROFIL */}
      <div className="bg-white/95 backdrop-blur rounded-2xl shadow-md border border-teal-100 overflow-hidden mb-8">
        <div className="bg-teal-800 p-6 text-white flex items-center space-x-5 shadow-sm">
          <div className="w-16 h-16 bg-teal-100 text-teal-800 rounded-full flex items-center justify-center text-3xl font-bold shadow-inner">
          ...
          <div>
            ...
            <p className="text-teal-200 text-sm font-medium tracking-wide">
              {profil?.role === 'ADMIN' ? 'Pentadbir Sistem' : 'Pengguna Bahagian / Unit'}
            </p>
          </div>
        </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-xs font-bold text-teal-800 uppercase tracking-wide mb-1.5">Akses Bahagian / Unit</label>
              <div className="p-3.5 bg-teal-50 rounded-xl border border-teal-100 font-bold text-teal-900 shadow-sm">
                {profil?.bahagian_akses || "TIADA AKSES KHUSUS"}
              </div>
            </div>
            <div>
              <label className="block text-xs font-bold text-teal-800 uppercase tracking-wide mb-1.5">Emel Log Masuk (Autentikasi)</label>
              <div className="p-3.5 bg-teal-50 rounded-xl border border-teal-100 font-mono text-teal-900 text-sm shadow-sm">
      ...
      <div className="bg-white/95 backdrop-blur rounded-2xl shadow-md border border-teal-100 overflow-hidden">
        ...
        <form onSubmit={handleTukarKatalaluan} className="p-6 space-y-6">
          ...
          <div>
            <label className="block text-xs font-bold text-teal-800 uppercase tracking-wide mb-2">Kata Laluan Baharu</label>
            <input 
              type="password" 
              required
              placeholder="Masukkan sekurang-kurangnya 6 aksara..."
              className="w-full px-4 py-3 border border-teal-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white shadow-sm font-medium"
              value={newPassword}
          ...
          <div>
            <label className="block text-xs font-bold text-teal-800 uppercase tracking-wide mb-2">Sahkan Kata Laluan Baharu</label>
            <input 
              type="password" 
              required
